                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            // 동영상 표시
                            System.out.println("mEditor video_url : " + server_info_url + "/Data/video_file/" + message);

                            mEditor.focusEditor();
                            mEditor.insertVideo(server_info_url + "/Data/video_file/" + video_path, 320, 320);
