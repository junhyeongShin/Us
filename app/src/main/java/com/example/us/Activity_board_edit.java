...
public class Activity_board_edit extends AppCompatActivity implements AdapterView.OnItemSelectedListener {

    private static final String TAG = "Activity_board_add : ";
    Activity_board_edit activity_board_edit = this;

    String server_info_url = server_info.getInstance().getURL();
    RichEditor mEditor;
    String img_path;
    String video_path;
    EditText edit_text_board_edit_title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit_text_board_edit_title = findViewById(R.id.edit_text_board_edit_title);
        edit_text_board_edit_title.setText(title);

        //카테고리 리스너
        //어뎁터를 이용해서 value - string - spinner_category 지정해놓은 값 불러옴.
        //초기값은 INTENT로 받아온 카테고리로 설정.

        int id_category = 5;
        if (category_selected.equals("파오캐")) {
            id_category = 0;
        } else if (category_selected.equals("카오스")) {
            id_category = 1;
        ...
        spinner_board_edit_category.setSelection(id_category);


        //툴바 뒤로가기 버튼
        ImageButton ibtn_board_edit = findViewById(R.id.ibtn_board_edit);
        ibtn_board_edit.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        //게시물 수정 버튼
        //1. 제목 작성했는지 확인
        //2. 서버로 제목, 카테고리, 내용 DB UPDATE 요청 GET
        //3. 결과값이 OK일경우 액티비티 종료 및 토스트창
        //3-1. 실패인경우 토스트창만 띄움

        final Button btn__board_edit = findViewById(R.id.btn__board_edit);
        btn__board_edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                System.out.println(TAG + "btn__board_edit Onclick");

                // 제목 카테고리 내용 받아오기
                // 제목
                final String title = edit_text_board_edit_title.getText().toString();
                ...
                if (title.equals("")) {
                    ...
                    retrofit_api.getData_edit_board(id,category,content,title).enqueue(new Callback<String>() {
                        @Override
        ...
        mEditor = (RichEditor) findViewById(R.id.editor_board_edit);
...
//        });
//
        findViewById(R.id.action_bold_board_edit).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mEditor.setBold();
            }
        ...
        findViewById(R.id.action_italic_board_edit).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mEditor.setItalic();
            }
...
//        });
//
        findViewById(R.id.action_underline_board_edit).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//
        findViewById(R.id.action_heading1_board_edit).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//        });
//
        findViewById(R.id.action_heading6_board_edit).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//
        findViewById(R.id.action_txt_color_board_edit).setOnClickListener(new View.OnClickListener() {
...
//        });
//
        findViewById(R.id.action_align_left_board_edit).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        findViewById(R.id.action_align_center_board_edit).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        findViewById(R.id.action_align_right_board_edit).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//        });
        ...
        findViewById(R.id.action_insert_image_board_edit).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//        });
        ...
        findViewById(R.id.action_insert_video_board_edit).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        findViewById(R.id.action_insert_link_board_edit).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                //데이터 담아서 팝업(액티비티) 호출
                AlertDialog.Builder ad = new AlertDialog.Builder(Activity_board_edit.this);

                ad.setTitle("링크 삽입하기");       // 제목 설정

                // EditText 삽입하기
                final EditText et_link = new EditText(Activity_board_edit.this);
                ad.setView(et_link);
